...
//!
//! This module re-exports the most commonly used types and traits from reflux-core.
//!
//! # Usage
//!
//! ```ignore
//! use reflux_core::prelude::*;
//! ```
//!
//! This brings the following into scope:
//!
//! - Core types: `Reflux`, `RefluxConfig`, `GameData`
...
pub use crate::reflux::{GameData, Reflux, RefluxConfig, RefluxConfigBuilder};
