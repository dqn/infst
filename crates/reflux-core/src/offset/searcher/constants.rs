...
/// Expected offset: playData - playSettings ≈ 0x2F0
///
/// Historical variation: ±0x30 (48 bytes)
/// - 2025122400 and later: 0x2F0 (752 bytes)
/// - Before 2025122400: 0x2C0 (704 bytes)
pub const PLAY_SETTINGS_TO_PLAY_DATA: u64 = 0x2F0;
